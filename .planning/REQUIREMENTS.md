...
- [ ] **FOUND-06**: Learner has IAM user configured (not root), AWS CLI working, and budget alerts set

### Deployment

- [ ] **DEPL-01**: Learner can deploy a React/Node app to EC2 manually (Nginx reverse proxy + PM2)
